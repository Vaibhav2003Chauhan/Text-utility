...
# super user id and pass is venom
...
def analyze(request):
    # if request.method=="GET":
        ...
        if(removepunc=='on'):
            ...
            param={'purpose':'Removing Punctuations ',
        ...
        if(rnum=="on"):
            ...
            param={'purpose':'Removing Numbers ',
                'analyzed_text':analyzed}
            rtext=analyzed
        ...
        if(newliner=="on"):
            ...
            print("analyze ")
            print(analyzed)
            param={'purpose':'Removing new line ',
                'analyzed_text':analyzed}
        ...
        if(rspace=="on"):
            ...
            param={'purpose':'Removing Extra spaces ',
                'analyzed_text':analyzed}
